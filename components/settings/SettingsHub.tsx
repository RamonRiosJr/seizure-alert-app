        ...
        >
          <div className="px-4 py-2 bg-slate-900 shadow-sm z-10">
            <TabsList className="grid w-full grid-cols-4 bg-slate-800">
              <TabsTrigger value="profile">
                ...
                <span className="hidden md:inline">{t('settingsContacts')}</span>
              </TabsTrigger>
              <TabsTrigger value="alerts">
                <Bell className="h-4 w-4 md:mr-2" />
                <span className="hidden md:inline">{t('alertsTab', 'Alerts')}</span>
              </TabsTrigger>
              <TabsTrigger value="ai">
                <Brain className="h-4 w-4 md:mr-2" />
                <span className="hidden md:inline">{t('aiHubTab', 'AI Hub')}</span>
              </TabsTrigger>
              <TabsTrigger value="system">
                <Cpu className="h-4 w-4 md:mr-2" />
                <span className="hidden md:inline">{t('systemTab', 'System')}</span>
              </TabsTrigger>
            </TabsList>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-20 safe-area-bottom">
            ...
            <TabsContent value="system" className="mt-0 space-y-4">
              <SystemTab onOpenDeviceManager={() => setIsDeviceManagerOpen(true)} />
            </TabsContent>
          </div>
        </Tabs>
      </div>
