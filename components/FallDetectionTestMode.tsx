  ...
  return (
    <div className="fixed inset-0 bg-gray-900 z-50 overflow-auto">
      ...
      <div className="p-6 space-y-6 max-w-2xl mx-auto">
        ...
        {/* Real-Time Graph */}
        <div>
          <h3 className="text-white font-semibold mb-2">{t('gForceHistory', 'G-Force History')}</h3>
        ...
        <div className="bg-gray-800 rounded-xl p-6">
          ...
          <ol className="space-y-3 text-gray-300">
            ...
            <li className="flex gap-3">
              ...
              <span>
                {t('testStep2', 'Shake vigorously or simulate a drop motion (without letting go!)')}
              </span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-orange-500 text-white rounded-full flex items-center justify-center text-sm font-bold">
            ...
            <li className="flex gap-3">
              ...
              <span>
                {t('testStep4', 'Watch for "Fall Confirmed" status and feel the vibration')}
              </span>
            </li>
          </ol>
          ...
          <div className="mt-4 p-3 bg-orange-900/20 border border-orange-500/30 rounded-lg text-sm text-orange-200">
            ...
            {t(
              'testModeNote',
              'Test mode will NOT trigger real emergency alerts. This is safe to test.'
            )}
          </div>
        </div>
