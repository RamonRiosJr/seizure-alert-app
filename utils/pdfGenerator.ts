...
export const generateSeizureReport = (
  ...
  autoTable(doc, {
    ...
    didDrawPage: (_data) => {
      ...
      // Disclaimer
      const disclaimer =
        'DISCLAIMER: This application and report are for informational purposes only and do not constitute medical advice, diagnosis, or treatment. Coqui Cloud Dev Co and its developers are not liable for any actions taken based on this information. Always consult a healthcare professional.';
      ...
      doc.text(
        ' | Coqui Cloud Dev Co',
        14 + doc.getTextWidth('Developed by RamonRios.NET'),
        pageHeight - 12
      );
